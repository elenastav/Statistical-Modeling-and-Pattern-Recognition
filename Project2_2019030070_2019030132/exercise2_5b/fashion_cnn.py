...
width, height, num_of_channels = 28, 28, 1

train_images_reshaped = train_images.reshape(-1, width, height, num_of_channels)  # reshape to num_train_images X height X width X channels, where channels = 1
test_images_reshaped = test_images.reshape(-1, width, height, num_of_channels)  # reshape


train_images_reshaped = train_images.reshape(-1, width, height,
                                             num_of_channels)  # reshape to mum_train_images X height X width X channels, where channels = 1
test_images_reshaped = test_images.reshape(-1, width, height, num_of_channels)  # reshape
...
plt.title('Testing accuracy for optimizer: ' + optimizer)
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
